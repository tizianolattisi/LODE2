 ...
 * Time: 11:03
 */
public class IPRecorderVolumeCheckerImpl implements VolumeChecker {

    class VolumeCheckerThread extends Thread {
        @Override
        public void run() {
